 ...
 */
class NewStackAction : AnAction("New Stack", "Create a new branch stack", null) {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            try {
                val storage  = StateStorage(root, ProcessGitRunner())
                ...
                NotificationGroupManager.getInstance()
                    ...
                    .createNotification(
                        "StackTree: could not create stack — ${ex.message}",
